...
from fhv_ride_record import dict_to_ride_record
from fhv_ride_record_key import dict_to_ride_record_key
from settings import (BOOTSTRAP_SERVERS, KAFKA_TOPIC, RIDE_KEY_SCHEMA_PATH,
                      RIDE_VALUE_SCHEMA_PATH, SCHEMA_REGISTRY_URL)
