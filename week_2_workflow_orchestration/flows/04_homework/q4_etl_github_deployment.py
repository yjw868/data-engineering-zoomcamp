...
from q4_etl_web_to_gcs import etl_parent_flow
...
deployment = Deployment.build_from_flow(
     ...
     entrypoint="week_2_workflow_orchestration/flows/04_homework/q4_etl_web_to_gcs.py:etl_parent_flow") # specify a subfolder of repo
